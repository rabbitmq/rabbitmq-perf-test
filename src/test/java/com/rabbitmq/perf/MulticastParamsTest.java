...
public class MulticastParamsTest {
  ...
  static Stream<Arguments> hasLimitArguments() {
    return Stream.of(
        ...
        of(
            tc(
                "Limited if consumer message and producer message count limit",
                -1,
                1000,
                1000,
                true)),
        ...
        of(
            tc(
                "Limited if time, consumer message, producer message count limit",
                10,
                1000,
                1000,
                true)));
  ...
  static class TestConfiguration {
    ...
    public TestConfiguration(
        String description, Consumer<MulticastParams> configurer, boolean expected) {
