...
public class CliTest {
    ...
    public void hasOptionString(String commandLine, boolean expectedArgumentValue) throws ParseException {
        CommandLineProxy cmd = cmd(commandLine);
    ...
    public void hasOptionChar(String commandLine, boolean expectedArgumentValue) throws ParseException {
        CommandLineProxy cmd = cmd(commandLine);
