...
publisher and consumer metrics provided by the http://www.rabbitmq.com/management.html[management UI].
...
http://www.rabbitmq.com/confirms.html[Consumer prefetch (QoS)] can be configured as well
