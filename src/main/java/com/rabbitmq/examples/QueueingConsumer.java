...
/**
 * Convenience class: an implementation of {@link com.rabbitmq.client.Consumer} with
 * straightforward blocking semantics.
 *
 * Deprecated in favor of {@link com.rabbitmq.client.DefaultConsumer} (see below for background).
 ...
 * {@link com.rabbitmq.client.ConnectionFactory} factory = new ConnectionFactory();
 * Connection conn = factory.newConnection();
 * {@link com.rabbitmq.client.Channel} ch1 = conn.createChannel();
 *
 * // Declare a queue and bind it to an exchange.
 * String queueName = ch1.queueDeclare().{@link com.rabbitmq.client.AMQP.Queue.DeclareOk#getQueue getQueue}();
 * ch1.{@link com.rabbitmq.client.Channel#queueBind queueBind}(queueName, exchangeName, queueName);
 *
 * // Create the QueueingConsumer and have it consume from the queue
 * QueueingConsumer consumer = new {@link QueueingConsumer#QueueingConsumer(com.rabbitmq.client.Channel) QueueingConsumer}(ch1);
 * ch1.{@link com.rabbitmq.client.Channel#basicConsume basicConsume}(queueName, false, consumer);
 *
 * // Process deliveries
 * while (/* some condition * /) {
 *     {@link QueueingConsumer.Delivery} delivery = consumer.{@link QueueingConsumer#nextDelivery nextDelivery}();
 *     // process delivery
 *     ch1.{@link com.rabbitmq.client.Channel#basicAck basicAck}(delivery.{@link QueueingConsumer.Delivery#getEnvelope getEnvelope}().{@link Envelope#getDeliveryTag getDeliveryTag}(), false);
 * }
 * </pre>
 *
 *
